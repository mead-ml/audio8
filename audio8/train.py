...
def train():
    ...
    parser.add_argument("--timestep_masking", type=float, default=0.05, help="Timestep masking prob")
    parser.add_argument("--timestep_mask_len", type=int, default=10, help="Num consecutive timesteps to mask")
    parser.add_argument("--channel_masking", type=float, default=0.0016, help="Channel masking prob")
